...
function CategoriesInput({
    ...
    function removeDuplicateSelectedSubCategories(newMainCategroy: FormOption | null) {
        setNewLocationFormData((prevData): NewLocationFormData => ({
            ...prevData,
            subCategoryIds: prevData.subCategoryIds.filter(id => id !== (newMainCategroy?.value || null)),
        }));
    }
